...
class MOFA extends StatelessWidget {
  final OtherServicesBloc otherServicesBloc;
  const MOFA({super.key, required this.otherServicesBloc});
        ...
        StreamBuilder(
            ...
            builder: (context, valueMOFA) {
              return CustomTextField(
                ...
                onchanged: otherServicesBloc.changeApplicantNameMofa,
              );
            }),
        const SizedBox(
          height: 20,
            ...
            builder: (context, valueESCOT) {
              ...
              return CustomElevatedButton(
                  onTap: !valueESCOT.hasData
                      ...
                      : () {
                          otherServicesBloc.mOFASubmit(context: context);
                        },
                  text: "Submit");
            }),
      ],
